...
resource "aws_ecs_service" "squid-ecr-ECSCluster__squid-ecr-ECSService-Kf9lgxSDQTcT" {
  ...
  cluster                            = data.aws_ssm_parameter.mesh-cluster.value
  ...
  network_configuration {
    ...
    security_groups = [
      data.aws_ssm_parameter.mesh-sg.value,
    ]
    subnets = [
      data.aws_ssm_parameter.mesh-subnet1.value,
      data.aws_ssm_parameter.mesh-subnet2.value,
      data.aws_ssm_parameter.mesh-subnet3.value,
    ]
  }
}
